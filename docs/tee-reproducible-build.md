...
> 这是当前生产值，对应 revision `3dfb01b73570fb25d99c2f84ff368f85abcfb599`。Grok 支持源码属于下一发布版；
> 流式修复前的候选 `650d3f81…a572` 已作废、从未上线。
>
> 待发布候选（**尚未上线**；受度量源码 revision
> `19122df6e69d4256e84eb5cf5c875ec4a197bab3`）：
> `4bec69861c775a59278f2775f7e7eda8bf4a8c8b15c039c31dd675591e6054b7be5609ba8dcd716f330f6242b23ea8af`。
> 2026-07-14 在生产 aarch64 构建机以 Docker 29.1.3 + nitro-cli 1.4.5 清空缓存双次构建，
> 两次一致（`REPRO_RESULT=MATCH`）。它须待 EIF 切换与真 attestation 核验后，
> 才能替换上面的当前生产规范值。
...
```bash
# 1. 复现当前生产值时 checkout 3dfb01b73570fb25d99c2f84ff368f85abcfb599；下一版则取已冻结的发布 revision
